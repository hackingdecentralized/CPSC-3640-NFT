...
contract CPSC3640NFT is ERC721, Ownable {
    ...
    function rawSVG() public pure returns (string memory) {
        ...
        "<path d='M406 360 C380 344 348 354 342 380 C336 408 358 426 386 420 C387 398 394 376 406 360 Z'/>\n"
        "<path d='M618 360 C644 344 676 354 682 380 C688 408 666 426 638 420 C637 398 630 376 618 360 Z'/>\n"
        "</g>\n"
        "<g fill='none' stroke='#5e3a26' stroke-width='2.5' opacity='0.7' stroke-linecap='round'>\n"
        "<path d='M380 372 C364 384 359 404 368 416'/>\n"
        "<path d='M644 372 C660 384 665 404 656 416'/>\n"
        "</g>\n"
        "\n"
        "<path d='M452 330 C490 322 534 322 572 330 C622 340 654 372 668 418 C688 470 698 518 696 558 C692 608 654 640 598 654 C570 660 542 662 512 662 C482 662 454 660 426 654 C370 640 332 608 328 558 C326 518 336 470 356 418 C370 372 402 340 452 330 Z' fill='#f4eee6' stroke='#c9bfae' stroke-width='2.5'/>\n"
        "\n"
        "<g fill='none' stroke='#d9cec0' stroke-linecap='round'>\n"
        "<path d='M512 380 V422' stroke-width='7'/>\n"
        "<path d='M400 412 C432 386 470 386 496 410' stroke-width='6'/>\n"
        "<path d='M624 412 C592 386 554 386 528 410' stroke-width='6'/>\n"
        "<path d='M362 476 C350 500 349 526 358 548' stroke-width='4.5'/>\n"
        "<path d='M662 476 C674 500 675 526 666 548' stroke-width='4.5'/>\n"
        "</g>\n"
        "\n"
        "<g fill='#16233a'>\n"
        "<ellipse cx='430' cy='456' rx='16' ry='15'/><ellipse cx='594' cy='456' rx='16' ry='15'/>\n"
        "</g>\n"
        "<g fill='#ffffff' opacity='0.9'>\n"
        "<circle cx='436' cy='451' r='5'/><circle cx='600' cy='451' r='5'/>\n"
        "</g>\n"
        "\n"
        "<path d='M512 472 C578 472 626 502 630 542 C634 580 628 608 606 626 C584 644 548 646 530 628 C522 620 516 614 512 608 C508 614 502 620 494 628 C476 646 440 644 418 626 C396 608 390 580 394 542 C398 502 446 472 512 472 Z' fill='#fbf7f1' stroke='#c9bfae' stroke-width='2'/>\n"
        "\n"
        "<path d='M512 484 C554 484 578 502 578 522 C578 544 548 558 512 558 C476 558 446 544 446 522 C446 502 470 484 512 484 Z' fill='#191920'/>\n"
        "<g fill='#4a4a58'>\n"
        "<ellipse cx='484' cy='520' rx='7' ry='10' transform='rotate(-20 484 520)'/>\n"
        "<ellipse cx='540' cy='520' rx='7' ry='10' transform='rotate(20 540 520)'/>\n"
        "</g>\n"
        "\n"
        ...
        "</g>\n"
        "<path d='M498 592 C498 618 526 618 526 592 Z' fill='#ff8fa3'/>\n"
        "\n"
